...
if __name__ == "__main__":
    ...
    list_data = ["../dataset/seed1/B_task1_test.json",
                "../dataset/seed77/B_task1_test.json",
                "../dataset/seed777/B_task1_test.json",
                ]
    vote_task1(list_data, "../dataset/submit/B_task1_test.json")
