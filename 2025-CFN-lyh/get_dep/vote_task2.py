...
if __name__ == "__main__":
    ...
    list_data = ["../dataset/seed1B/B_task2_test.json",
                "../dataset/seed77C/B_task2_test.json",
                "../dataset/seed777C/B_task2_test.json",
                ]
    vote_task2(list_data, "../dataset/vote4/B_task2_test.json", num_vote=2)
